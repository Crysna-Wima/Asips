...
class HistoryPosyanduuserController extends Controller
{
    public function index(){
        ...
        return view('dashboard.historyPosyanduuser',['history' => $history],['jumlah1' => $jumlah1, 'jumlah1' =>$jumlah1]);
    ...
    public function edit($id){
        ...
        return view('edit.editHistoryPosyanduuser',['history' => $history, 'jumlah' => $jumlah,'jumlah1' => $jumlah1]);
    }
