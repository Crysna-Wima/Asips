...
Route::group(['middleware' => ['auth']], function(){
    Route::group(['middleware' => ['cek_login:admin']], function() {
        ...
        Route::get('/balita/print', 'App\Http\Controllers\balitaController@print');
        ...
        Route::get('historyPosyandu/print','App\Http\Controllers\HistoryPosyanduController@print');
