...
<body>
    <div class="container">
        <div class="card-header py-3" style="margin: 20px">
            <a type="button" class="btn btn-primary" href="/balita">Kembali</a>
        </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a type="button" class="btn btn-success" href="/balita/restore/{{ $item->ID_BALITA }}" style="color: white" onclick="return confirm('Apakah anda ingin memulihkannya?')">Restore</a></td>                                         
                    </tr>
                    @endforeach       
                </tbody>
            </table>
